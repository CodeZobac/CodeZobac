...
>
>𝗔𝗹-𝗗𝗿𝗶𝘃𝗲𝗻 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗺𝗲𝗻𝘁:  I structure Al-assisted delivery through project-specific AGENTS. md instructions and Serena MCP for codebase understanding and durable documentation. I >select Codex for daily development and Claude Code for heavier requirements, then use pre-commit checks and CodeRabbit review as quality gates before changes move forward.
>
>𝗢𝗯𝗷𝗲𝗰𝘁𝗶𝘃𝗲:  Transforming complex technical requirements into resilient, client-ready architectures.
>
>𝗦𝗽𝗶𝗿𝗶𝘁𝘂𝗮𝗹 𝗴𝗿𝗼𝘄𝘁𝗵  is an important part of my personal development. I practise  𝗥𝗲𝗶𝗸𝗶  and draw on 𝗔𝘆𝘂𝗿𝘃𝗲𝗱𝗶𝗰 𝗽𝗿𝗶𝗻𝗰𝗶𝗽𝗹𝗲𝘀  toguide my dietary choices.
>
>𝗧𝗶𝗺𝗲 𝗶𝗻 𝗻𝗮𝘁𝘂𝗿𝗲  brings balance to everyday city life, with  𝘀𝗲𝗮 𝘀𝘄𝗶𝗺𝗺𝗶𝗻𝗴  as my preferred form of exercise. I also practise 𝗺𝗮𝗿𝘁𝗶𝗮𝗹 𝗮𝗿𝘁𝘀 , making space for both physical discipline >and reflection.
---
